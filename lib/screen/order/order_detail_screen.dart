...
class OrderDetailScreen extends StatefulWidget {
  ...
  const OrderDetailScreen({Key key, this.isDelivering = false})
      : super(key: key);
        ...
        body: SafeArea(
            child: ListView(children: <Widget>[
                  ...
                  children: <Widget>[
                    Text("Giao hàng tận nơi.",
                        style: TextStyle(
                            ...
                            height: 1.3,
                            color: Colors.black)),
                    widget.isDelivering ? SizedBox() : Text(
              ...
              WidgetUtil.getLine(
                  width: SizeUtil.tinySpace,
                  color:
                  widget.isDelivering ? ColorUtil.white : ColorUtil.lineColor,
                  margin: EdgeInsets.all(0)),
              widget.isDelivering
                  ? SizedBox(
                height: SizeUtil.smallSpace,

...
class _OrderDetailScreenState extends BaseState<OrderDetailScreen> {
  ...
  Widget buildWidget(BuildContext context) {
    ...
    return Consumer<BookingDetailProvider>(builder: (BuildContext context, BookingDetailProvider value, Widget child) {
      ...
      return Scaffold(
          ...
          body: ListView(children: <Widget>[
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Text(
                      S
                          .of(context)
                          .order_header(data['code'], data['date_booking'] +" " +  data['time_booking']),
            ...
            OrderInfo(
              ...
              contentNote:
              isDelivering ? null : " (Thời gian: 09:00-12:00 22/12/2019)",
            ),
            OrderInfo(
                ...
                child: Column(
                    children: List.generate(
                        data["list_product"].length,
                          ...
                          productCount: data["list_product"][index]['number'],
                        ))),
              ),
            ),
            WidgetUtil.getLine(

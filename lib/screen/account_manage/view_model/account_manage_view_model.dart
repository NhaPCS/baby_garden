...
class AccountManageViewModel extends BaseViewModel {
  ...
  Future<void> addChild({String name, int gender, String birthday, File img}) async {
    var data = await service.addBaby(context, name: name, gender: gender, birthday: birthday, img: img);
    if(data!=null){

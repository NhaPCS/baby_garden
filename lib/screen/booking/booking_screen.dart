...
class _BookingScreenState extends BaseState<BookingScreen> with SingleTickerProviderStateMixin {
  ...
  final CheckoutMethodProvider _checkoutMethodProvider = new CheckoutMethodProvider();
  final TransferMethodProvider _transferMethodProvider = new TransferMethodProvider();
    ...
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          ...
          //TODO receive time
          Consumer<DeliveryMethodProvider>(builder: (BuildContext context, DeliveryMethodProvider value, Widget child) {
                  ...
                  children: <Widget>[
                    ...
                    InkWell(
                      onTap: () {
                        ...
                        showDialog(
                            context: context, builder: (_) => ChangeDeliveryTimeDialogue(dayTabControler: _dayTabControler,changeDeliveryTimeProvider: _changeDeliveryTimeProvider,));
//                            showChangeReceiveTimeDialogue(context, myTabs);
                ...
                text: TextSpan(children: <TextSpan>[
                  ...
                  TextSpan(
                      recognizer: new TapGestureRecognizer()
                        ..onTap = () => showDialog(
                            context: context, builder: (BuildContext context) => PrivacyAndPolicyDialogue()),
  ...
  Widget getTransferService() {
    return Consumer<TransferMethodProvider>(builder: (BuildContext context, TransferMethodProvider value, Widget child) {
      return Column(
  ...
  Widget getCheckoutMenthod() {
    return Consumer<CheckoutMethodProvider>(builder: (BuildContext context, CheckoutMethodProvider value, Widget child) {
      return Column(
        mainAxisAlignment: MainAxisAlignment.start,
        children: <Widget>[
          CustomRadioButton(
                  ...
                  onTap: (){
                    setState(() {
                      ...
                      if(_notifySwitchProvider.isEnable){
                        showDialog(
                            context: context, builder: (BuildContext context) => PointCheckoutDialogue());
                      }
                    });
                  },
                  child: Text(
  ...
  Widget getDeliveryMenthod() {
    return Consumer<DeliveryMethodProvider>(builder: (BuildContext context, DeliveryMethodProvider value, Widget child) {
      return Column(
        mainAxisAlignment: MainAxisAlignment.start,
        children: <Widget>[
          CustomRadioButton(

...
class ReceiveAddressListProvider extends ChangeNotifier{
  ...
  Future<void> getData() async {
    ...
    if(data!=null){
      addressList.add({"address_detail":data['main_address'],"userName":"","phone":"","address":"","districtID":"","cityID":""});
      for (var address in data['list_address']) {
        addressList.add({"address_detail":address['address'],"userName":"","phone":"","address":"","districtID":"","cityID":""});
      }

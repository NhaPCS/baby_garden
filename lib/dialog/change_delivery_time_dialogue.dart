...
class ChangeDeliveryTimeDialogue extends StatelessWidget{
  ...
  const ChangeDeliveryTimeDialogue({Key key,this.dayTabControler,this.changeDeliveryTimeProvider}):super(key:key);
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider.value(value: changeDeliveryTimeProvider,child: Dialog(
              ...
              child: Column(
                ...
                children: <Widget>[
                  TabBar(
                    ...
                    onTap: (val) {
//                      setState(() =>
//                      {isHasReceiveTime = dayTabControler.index != 1});
                    },
                  ),
                  WidgetUtil.getLine(
                      margin: EdgeInsets.only(bottom: SizeUtil.tinySpace),
                      color: ColorUtil.lineColor),
                  Consumer<ChangeDeliveryTimeProvider>(builder: (BuildContext context, ChangeDeliveryTimeProvider value, Widget child) {
                    return Column(
                      ...
                      children: <Widget>[
                        CustomRadioButton(
                          ...
                          value: 0,
                          groupValue: changeDeliveryTimeProvider.receiveTime,
                          iconSize: SizeUtil.iconSize,
                          titleSize: SizeUtil.textSizeSmall,
                          onChanged: (val) {
                            changeDeliveryTimeProvider.onChangeTime(val);
